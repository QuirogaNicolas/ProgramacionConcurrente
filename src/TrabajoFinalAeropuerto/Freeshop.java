...
public class Freeshop {
    ...
    public void entrarFreeShop() throws InterruptedException {
        // Los pasajeros van a entrar al freeshop solo si hay lugar disponible, en este
        // caso, los freeshop tienen lugar para 3 personas
        try {
            semEntrar.acquire();
        } catch (InterruptedException e) {
            // Se va a interrumpir a los pasajeros que estén esperando en la fila del
            // freeshop cuando cierre el aeropuerto
    ...
    public void pagarFreeshop(int valorCompra) {
        // Primero los pasajeros intentan pagar en cada caja por si hay alguna vacía. Si
        // las dos están ocupadas eligen una al azar
        boolean pago = false;
